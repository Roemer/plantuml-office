...
LyncLegacy | OFF_LYNC | ![lync](/office2014/LyncLegacy/lync.png?raw=true) | LyncLegacy/lync.puml
LyncLegacy | OFF_LYNCPHONEEDITION | ![lyncphoneedition](/office2014/LyncLegacy/lyncphoneedition.png?raw=true) | LyncLegacy/lyncphoneedition.puml
LyncLegacy | OFF_LYNCROOMSYSTEM | ![lyncroomsystem](/office2014/LyncLegacy/lyncroomsystem.png?raw=true) | LyncLegacy/lyncroomsystem.puml
LyncLegacy | OFF_LYNCSERVER | ![lyncserver](/office2014/LyncLegacy/lyncserver.png?raw=true) | LyncLegacy/lyncserver.puml
LyncLegacy | OFF_LYNCSERVERMANAGEMENTTOOL | ![lyncservermanagementtool](/office2014/LyncLegacy/lyncservermanagementtool.png?raw=true) | LyncLegacy/lyncservermanagementtool.puml
LyncLegacy | OFF_LYNCSTORAGESERVICE | ![lyncstorageservice](/office2014/LyncLegacy/lyncstorageservice.png?raw=true) | LyncLegacy/lyncstorageservice.puml
LyncLegacy | OFF_LYNCWEBAPPCLIENT | ![lyncwebappclient](/office2014/LyncLegacy/lyncwebappclient.png?raw=true) | LyncLegacy/lyncwebappclient.puml
LyncLegacy | OFF_LYNC_BACK_END_SERVER | ![lync_back_end_server](/office2014/LyncLegacy/lync_back_end_server.png?raw=true) | LyncLegacy/lync_back_end_server.puml
LyncLegacy | OFF_LYNC_BACK_END_SERVER_MIRROR | ![lync_back_end_server_mirror](/office2014/LyncLegacy/lync_back_end_server_mirror.png?raw=true) | LyncLegacy/lync_back_end_server_mirror.puml
LyncLegacy | OFF_LYNC_CONTROL_PANEL | ![lync_control_panel](/office2014/LyncLegacy/lync_control_panel.png?raw=true) | LyncLegacy/lync_control_panel.puml
LyncLegacy | OFF_LYNC_DIRECTOR | ![lync_director](/office2014/LyncLegacy/lync_director.png?raw=true) | LyncLegacy/lync_director.puml
LyncLegacy | OFF_LYNC_DIRECTOR_ARRAY | ![lync_director_array](/office2014/LyncLegacy/lync_director_array.png?raw=true) | LyncLegacy/lync_director_array.puml
LyncLegacy | OFF_LYNC_EDGE_SERVER | ![lync_edge_server](/office2014/LyncLegacy/lync_edge_server.png?raw=true) | LyncLegacy/lync_edge_server.puml
LyncLegacy | OFF_LYNC_EDGE_SERVER_POOL | ![lync_edge_server_pool](/office2014/LyncLegacy/lync_edge_server_pool.png?raw=true) | LyncLegacy/lync_edge_server_pool.puml
LyncLegacy | OFF_LYNC_FRONT_END_POOL | ![lync_front_end_pool](/office2014/LyncLegacy/lync_front_end_pool.png?raw=true) | LyncLegacy/lync_front_end_pool.puml
LyncLegacy | OFF_LYNC_FRONT_END_SERVER | ![lync_front_end_server](/office2014/LyncLegacy/lync_front_end_server.png?raw=true) | LyncLegacy/lync_front_end_server.puml
LyncLegacy | OFF_LYNC_MEDIATION_SERVER | ![lync_mediation_server](/office2014/LyncLegacy/lync_mediation_server.png?raw=true) | LyncLegacy/lync_mediation_server.puml
LyncLegacy | OFF_LYNC_MONITORING_SERVER | ![lync_monitoring_server](/office2014/LyncLegacy/lync_monitoring_server.png?raw=true) | LyncLegacy/lync_monitoring_server.puml
LyncLegacy | OFF_LYNC_PERSISTENT_CHAT_SERVER | ![lync_persistent_chat_server](/office2014/LyncLegacy/lync_persistent_chat_server.png?raw=true) | LyncLegacy/lync_persistent_chat_server.puml
LyncLegacy | OFF_LYNC_USER | ![lync_user](/office2014/LyncLegacy/lync_user.png?raw=true) | LyncLegacy/lync_user.puml
